...
{ TObject.Dispatch accepts any data type as its Message parameter.  The
  ...
  TObject = class
    ...
    class function InstanceSize: NativeInt;
...
function InterLockedIncrement(var dest: Integer): Integer;
function InterLockedIncrement64(var dest: Int64): Int64;
function InterLockedDecrement(var dest: Integer): Integer;
function InterLockedDecrement64(var dest: Int64): Int64;
function InterLockedCompareExchange(var dest: Integer; exchange, comparand: Integer): Integer;
function InterLockedCompareExchange64(var dest: Int64; exchange, comparand: Int64): Int64;
function InterLockedExchange(var dest: Integer; value: Integer): Integer;
function InterLockedExchange64(var dest: Int64; value: Int64): Int64;
function InterLockedExchangeAdd(var dest: Integer; value: Integer): Integer;
function InterLockedExchangeAdd64(var dest: Int64; value: Int64): Int64;
procedure _CrtExit(code: Integer);
...
procedure _Rethrow(exobj: TObject);
procedure _FreeExceptObject(exobj: TObject);
...
procedure FillChar(var Dest; Count: NativeInt; Value: AnsiChar); begin end;
procedure Move(const Source; var Dest; Count: NativeInt); begin end;
function InterLockedIncrement(var dest: Integer): Integer; begin end;
function InterLockedIncrement64(var dest: Int64): Int64; begin end;
function InterLockedDecrement(var dest: Integer): Integer; begin end;
function InterLockedDecrement64(var dest: Int64): Int64; begin end;
function InterLockedCompareExchange(var dest: Integer; exchange, comparand: Integer): Integer; begin end;
function InterLockedCompareExchange64(var dest: Int64; exchange, comparand: Int64): Int64; begin end;
function InterLockedExchange(var dest: Integer; value: Integer): Integer; begin end;
function InterLockedExchange64(var dest: Int64; value: Int64): Int64; begin end;
function InterLockedExchangeAdd(var dest: Integer; value: Integer): Integer; begin end;
function InterLockedExchangeAdd64(var dest: Int64; value: Int64): Int64; begin end;
procedure _CrtExit(code: Integer); begin end;
...
procedure _Rethrow(exobj: TObject); begin end;
procedure _FreeExceptObject(exobj: TObject); begin end;

procedure _HandleSafecallExcept(Instance, ExceptObject: TObject);
begin
end;

procedure _HandleFinally(ExceptObject: TObject); begin end;
...
begin
  ...
  PNativeInt(Instance)^ := NativeInt(Self);
  ClassPtr := Self;
  while ClassPtr <> nil do
  begin
    IntfTable := ClassPtr.GetInterfaceTable;
    if IntfTable <> nil then
      for I := 0 to IntfTable.EntryCount-1 do
        ...
        begin
          if VTable <> nil then
            PNativeInt(@PChar(Instance)[IOffset])^ := NativeInt(VTable);
        end;
    ClassPtr := ClassPtr.ClassParent;
  end;
  Result := Instance;
...
class function TObject.InstanceSize: NativeInt;
begin
  Result := PNativeInt(NativeInt(Self) + vmtInstanceSize)^;
end;
